...
class JsonView(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.root_item = QtWidgets.QTreeWidgetItem(["Root"])
    ...
    def openFile(self, strFileName):
        ...
        jfile = open(strFileName, encoding='utf-8-sig')
        jdata = json.load(jfile, object_pairs_hook=collections.OrderedDict)
        self.recurse_jdata(jdata, self.root_item)
...
class JsonViewer(QtWidgets.QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.json_view = JsonView(self)

        self.setGeometry(10, 30, 500, 440)  # x, y, w, h
        self.setCentralWidget(self.json_view)
        self.setWindowTitle("JSON Viewer")

    def showJson(self, jsonPath):
        self.json_view.openFile(jsonPath)
        self.show()
